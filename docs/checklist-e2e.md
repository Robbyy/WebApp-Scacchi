...
- [ ] **82. Raggruppamento degli studi Mediogioco per tipologia** — `/middlegame` mostra nell'ordine
  «Studi di tattica» e «Studi di strategia» anche quando uno dei gruppi è vuoto, preserva l'ordine
  ricevuto dal backend dentro ciascun gruppo e non ripete il badge di tipologia nelle card. «Da
  classificare» compare soltanto se esistono studi legacy con `studyType` nullo e scompare dopo
  l'eliminazione dell'ultimo; link, conteggi, eliminazione e CTA «Nuovo studio» restano operativi.
  `/endgame` conserva la lista unica. Verificare inoltre l'assenza di overflow a
  1600/1440/1024/768/375/320px e di errori inattesi in console.
