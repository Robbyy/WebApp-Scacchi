...
| `issue-016-middlegame-guided-study-model` *(R26.3, attiva: authoring validato)* | Introdurre tipologia tattica/strategica, catalogo temi normalizzato, metadati e ordine delle posizioni, storico minimo, migrazioni e API. | R26.2 chiusa; preflight e analisi approvati; governance `openspec-v2` pendente. | Proposal/design/spec/tasks completi e validi in strict; prima dei 40 task servono triage standalone e tre gate indipendenti `READY`. Modello e compatibilità legacy devono essere verificati senza attivare ancora i flussi guidati. |
| `issue-016-middlegame-guided-study-flows` *(R26.3, attiva: authoring validato)* | Realizzare esercizi tattici e strategici, soluzione, motore esplorativo, modalità manuale/sequenziale, filtri e riepiloghi. | Change modello da governare, implementare, verificare e archiviare prima dei task di questa change; governance propria pendente. | Proposal/design/spec/tasks completi e validi in strict; prima dei 55 task servono i gate indipendenti `READY`. R26.3 completa solo con test, build e flussi E2E 68–81 verdi. |
...
R26.2 ha chiuso la gerarchia contestuale dell'editor. R26.3 aggiunge lo studio guidato del
Mediogioco prima di R27 tramite le due change sequenziali sopra; le slice successive non devono
ridecidere le decisioni già consolidate nel preflight e nell'analisi.
