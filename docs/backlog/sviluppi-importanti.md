...
| `issue-016-position-editor-contextual-actions` ✅ *(R26.2 implementata, verificata e archiviata 2026-08-14)* | Rifinire il contesto dell'editor posizionale prima del Finale: breadcrumb non interattivo, gerarchia «Mosse & rami» e rimozione di comandi/etichette ridondanti. | R26.1 chiusa e archiviata. | Cinque contratti chiusi e verificati in Mediogioco (461 test frontend, flussi 64–66 ai sei viewport); il Finale dovrà ridimostrarli con dati `ENDGAME`. Change archiviata senza `--skip-specs`. Follow-up `f5bbb25` sul setup editor: suite a 462 test e flusso browser 67 superato il 2026-08-16 su H2 temporaneo. |
| `issue-016-middlegame-guided-study-model` *(R26.3, archiviata 2026-08-17)* | Introdurre tipologia tattica/strategica, catalogo temi normalizzato, metadati e ordine delle posizioni, storico minimo, migrazioni e API. | R26.2 chiusa; preflight e analisi approvati. | 40/40 task completati, verificati e archiviati; modello e compatibilità legacy verificati con 191 test backend, regressioni frontend e flussi E2E 68–71. |
| `issue-016-middlegame-guided-study-flows` *(R26.3, archiviata 2026-08-19)* | Realizzare esercizi tattici e strategici, soluzione, motore esplorativo, modalità manuale/sequenziale, filtri e riepiloghi. | Change modello archiviata e spec canoniche disponibili. | **55/55 task completati** (gate B9) con 692 test frontend, 191 backend e build verdi; flussi E2E 72–81 (inclusa regressione 68–71) verificati su H2 temporaneo. Con questa change **R26.3 è rilasciata**. |
| `issue-016-endgame-section` | Rendere reale la sezione Finale riusando il modello e le componenti definite per Mediogioco. | R26.3 completata; R26.2 e R26.1 archiviate. | Vista lista/dettaglio/editor per studi e posizioni di finale, senza import Lichess; matrice completa R26.1/R26.2 verificata con dati `ENDGAME`, rotte `/endgame`, sei viewport e regressioni Aperture/Mediogioco. Il riuso non sostituisce i test. **Non eredita automaticamente** la tipologia tattica/strategica né i flussi guidati di R26.3: un'estensione dello studio guidato al Finale resta una decisione di prodotto futura ed esplicita. |
...
R26.2 ha chiuso la gerarchia contestuale dell'editor. R26.3 ha aggiunto lo studio guidato del
Mediogioco tramite le due change sequenziali sopra, entrambe archiviate; è il rilascio che precede
R27. Le slice successive non devono ridecidere le decisioni già consolidate nel preflight e
nell'analisi.
